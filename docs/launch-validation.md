...
La política aprobada sigue siendo free-only. La documentación oficial de precios de AI Gateway describe el crédito mensual gratuito, pero el runtime de esta cuenta exige además verificación mediante tarjeta: <https://vercel.com/docs/ai-gateway/pricing>.
